...
const NetworkObjectiveForm: React.FC<NetworkObjectiveFormProps> = ({ onSubmit, onClose, initialData }) => {
      ...
      <div className="bg-white rounded-lg shadow-xl w-full max-w-md">
        <div className="flex items-center justify-between p-4 border-b">
          <h2 className="text-lg font-semibold">
            {initialData ? 'Editar' : 'Nuevo'} Objetivo de Red
          </h2>
...
export default NetworkObjectiveForm;