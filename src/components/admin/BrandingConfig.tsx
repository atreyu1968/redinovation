...
const BrandingConfig = () => {
  ...
  useEffect(() => {
    ...
    document.documentElement.style.setProperty('--primary-color', formData.colors.primary);
    document.documentElement.style.setProperty('--secondary-color', formData.colors.secondary);
    document.documentElement.style.setProperty('--accent-color', formData.colors.accent);
  }, [formData]);
